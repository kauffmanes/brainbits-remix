...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create brainbits-remix-da27
  fly apps create brainbits-remix-da27-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app brainbits-remix-da27
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app brainbits-remix-da27-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'brainbits-remix-da27-staging' does not match app name in config file 'brainbits-remix-da27'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name brainbits-remix-da27-db
  fly postgres attach --app brainbits-remix-da27 brainbits-remix-da27-db

  fly postgres create --name brainbits-remix-da27-staging-db
  fly postgres attach --app brainbits-remix-da27-staging brainbits-remix-da27-staging-db
  ```
...
# Welcome to BrainBits

## Issues

https://github.com/kauffmanes/brainbits-ui/issues
